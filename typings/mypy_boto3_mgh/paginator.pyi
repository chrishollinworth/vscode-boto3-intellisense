...
class ListApplicationStatesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListApplicationStates.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.14.47/reference/services/mgh.html#MigrationHub.Paginator.ListApplicationStates.paginate)
        """
...
class ListCreatedArtifactsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListCreatedArtifacts.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.14.47/reference/services/mgh.html#MigrationHub.Paginator.ListCreatedArtifacts.paginate)
        """
...
class ListDiscoveredResourcesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListDiscoveredResources.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.14.47/reference/services/mgh.html#MigrationHub.Paginator.ListDiscoveredResources.paginate)
        """
...
class ListMigrationTasksPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListMigrationTasks.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.14.47/reference/services/mgh.html#MigrationHub.Paginator.ListMigrationTasks.paginate)
        """
...
class ListProgressUpdateStreamsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListProgressUpdateStreams.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.14.47/reference/services/mgh.html#MigrationHub.Paginator.ListProgressUpdateStreams.paginate)
        """
