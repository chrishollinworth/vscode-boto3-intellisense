...
class ListJobsByPipelinePaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListJobsByPipeline.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.14.47/reference/services/elastictranscoder.html#ElasticTranscoder.Paginator.ListJobsByPipeline.paginate)
        """
...
class ListJobsByStatusPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListJobsByStatus.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.14.47/reference/services/elastictranscoder.html#ElasticTranscoder.Paginator.ListJobsByStatus.paginate)
        """
...
class ListPipelinesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListPipelines.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.14.47/reference/services/elastictranscoder.html#ElasticTranscoder.Paginator.ListPipelines.paginate)
        """
...
class ListPresetsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListPresets.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.14.47/reference/services/elastictranscoder.html#ElasticTranscoder.Paginator.ListPresets.paginate)
        """
