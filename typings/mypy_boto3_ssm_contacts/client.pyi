...
class SSMContactsClient(BaseClient):
    """
    [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/ssm-contacts.html#SSMContacts.Client)
    ...
    def accept_page(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/ssm-contacts.html#SSMContacts.Client.accept_page)
    ...
    def activate_contact_channel(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/ssm-contacts.html#SSMContacts.Client.activate_contact_channel)
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/ssm-contacts.html#SSMContacts.Client.can_paginate)
    ...
    def create_contact(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/ssm-contacts.html#SSMContacts.Client.create_contact)
    ...
    def create_contact_channel(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/ssm-contacts.html#SSMContacts.Client.create_contact_channel)
    ...
    def deactivate_contact_channel(self, *, ContactChannelId: str) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/ssm-contacts.html#SSMContacts.Client.deactivate_contact_channel)
    ...
    def delete_contact(self, *, ContactId: str) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/ssm-contacts.html#SSMContacts.Client.delete_contact)
    ...
    def delete_contact_channel(self, *, ContactChannelId: str) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/ssm-contacts.html#SSMContacts.Client.delete_contact_channel)
    ...
    def describe_engagement(self, *, EngagementId: str) -> DescribeEngagementResultTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/ssm-contacts.html#SSMContacts.Client.describe_engagement)
    ...
    def describe_page(self, *, PageId: str) -> DescribePageResultTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/ssm-contacts.html#SSMContacts.Client.describe_page)
    ...
    def generate_presigned_url(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/ssm-contacts.html#SSMContacts.Client.generate_presigned_url)
    ...
    def get_contact(self, *, ContactId: str) -> GetContactResultTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/ssm-contacts.html#SSMContacts.Client.get_contact)
    ...
    def get_contact_channel(self, *, ContactChannelId: str) -> GetContactChannelResultTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/ssm-contacts.html#SSMContacts.Client.get_contact_channel)
    ...
    def get_contact_policy(self, *, ContactArn: str) -> GetContactPolicyResultTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/ssm-contacts.html#SSMContacts.Client.get_contact_policy)
    ...
    def list_contact_channels(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/ssm-contacts.html#SSMContacts.Client.list_contact_channels)
    ...
    def list_contacts(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/ssm-contacts.html#SSMContacts.Client.list_contacts)
    ...
    def list_engagements(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/ssm-contacts.html#SSMContacts.Client.list_engagements)
    ...
    def list_page_receipts(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/ssm-contacts.html#SSMContacts.Client.list_page_receipts)
    ...
    def list_pages_by_contact(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/ssm-contacts.html#SSMContacts.Client.list_pages_by_contact)
    ...
    def list_pages_by_engagement(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/ssm-contacts.html#SSMContacts.Client.list_pages_by_engagement)
    ...
    def list_tags_for_resource(self, *, ResourceARN: str) -> ListTagsForResourceResultTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/ssm-contacts.html#SSMContacts.Client.list_tags_for_resource)
    ...
    def put_contact_policy(self, *, ContactArn: str, Policy: str) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/ssm-contacts.html#SSMContacts.Client.put_contact_policy)
    ...
    def send_activation_code(self, *, ContactChannelId: str) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/ssm-contacts.html#SSMContacts.Client.send_activation_code)
    ...
    def start_engagement(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/ssm-contacts.html#SSMContacts.Client.start_engagement)
    ...
    def stop_engagement(self, *, EngagementId: str, Reason: str = None) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/ssm-contacts.html#SSMContacts.Client.stop_engagement)
    ...
    def tag_resource(self, *, ResourceARN: str, Tags: List["TagTypeDef"]) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/ssm-contacts.html#SSMContacts.Client.tag_resource)
    ...
    def untag_resource(self, *, ResourceARN: str, TagKeys: List[str]) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/ssm-contacts.html#SSMContacts.Client.untag_resource)
    ...
    def update_contact(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/ssm-contacts.html#SSMContacts.Client.update_contact)
    ...
    def update_contact_channel(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/ssm-contacts.html#SSMContacts.Client.update_contact_channel)
    ...
    def get_paginator(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/ssm-contacts.html#SSMContacts.Paginator.ListContactChannels)
    ...
    def get_paginator(self, operation_name: Literal["list_contacts"]) -> ListContactsPaginator:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/ssm-contacts.html#SSMContacts.Paginator.ListContacts)
    ...
    def get_paginator(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/ssm-contacts.html#SSMContacts.Paginator.ListEngagements)
    ...
    def get_paginator(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/ssm-contacts.html#SSMContacts.Paginator.ListPageReceipts)
    ...
    def get_paginator(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/ssm-contacts.html#SSMContacts.Paginator.ListPagesByContact)
    ...
    def get_paginator(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/ssm-contacts.html#SSMContacts.Paginator.ListPagesByEngagement)
