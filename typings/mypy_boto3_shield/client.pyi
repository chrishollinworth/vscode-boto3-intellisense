...
class ShieldClient(BaseClient):
    """
    [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/shield.html#Shield.Client)
    ...
    def associate_drt_log_bucket(self, *, LogBucket: str) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/shield.html#Shield.Client.associate_drt_log_bucket)
    ...
    def associate_drt_role(self, *, RoleArn: str) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/shield.html#Shield.Client.associate_drt_role)
    ...
    def associate_health_check(self, *, ProtectionId: str, HealthCheckArn: str) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/shield.html#Shield.Client.associate_health_check)
    ...
    def associate_proactive_engagement_details(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/shield.html#Shield.Client.associate_proactive_engagement_details)
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/shield.html#Shield.Client.can_paginate)
    ...
    def create_protection(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/shield.html#Shield.Client.create_protection)
    ...
    def create_protection_group(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/shield.html#Shield.Client.create_protection_group)
    ...
    def create_subscription(self) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/shield.html#Shield.Client.create_subscription)
    ...
    def delete_protection(self, *, ProtectionId: str) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/shield.html#Shield.Client.delete_protection)
    ...
    def delete_protection_group(self, *, ProtectionGroupId: str) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/shield.html#Shield.Client.delete_protection_group)
    ...
    def delete_subscription(self) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/shield.html#Shield.Client.delete_subscription)
    ...
    def describe_attack(self, *, AttackId: str) -> DescribeAttackResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/shield.html#Shield.Client.describe_attack)
    ...
    def describe_attack_statistics(self) -> DescribeAttackStatisticsResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/shield.html#Shield.Client.describe_attack_statistics)
    ...
    def describe_drt_access(self) -> DescribeDRTAccessResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/shield.html#Shield.Client.describe_drt_access)
    ...
    def describe_emergency_contact_settings(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/shield.html#Shield.Client.describe_emergency_contact_settings)
    ...
    def describe_protection(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/shield.html#Shield.Client.describe_protection)
    ...
    def describe_protection_group(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/shield.html#Shield.Client.describe_protection_group)
    ...
    def describe_subscription(self) -> DescribeSubscriptionResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/shield.html#Shield.Client.describe_subscription)
    ...
    def disable_proactive_engagement(self) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/shield.html#Shield.Client.disable_proactive_engagement)
    ...
    def disassociate_drt_log_bucket(self, *, LogBucket: str) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/shield.html#Shield.Client.disassociate_drt_log_bucket)
    ...
    def disassociate_drt_role(self) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/shield.html#Shield.Client.disassociate_drt_role)
    ...
    def disassociate_health_check(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/shield.html#Shield.Client.disassociate_health_check)
    ...
    def enable_proactive_engagement(self) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/shield.html#Shield.Client.enable_proactive_engagement)
    ...
    def generate_presigned_url(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/shield.html#Shield.Client.generate_presigned_url)
    ...
    def get_subscription_state(self) -> GetSubscriptionStateResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/shield.html#Shield.Client.get_subscription_state)
    ...
    def list_attacks(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/shield.html#Shield.Client.list_attacks)
    ...
    def list_protection_groups(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/shield.html#Shield.Client.list_protection_groups)
    ...
    def list_protections(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/shield.html#Shield.Client.list_protections)
    ...
    def list_resources_in_protection_group(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/shield.html#Shield.Client.list_resources_in_protection_group)
    ...
    def list_tags_for_resource(self, *, ResourceARN: str) -> ListTagsForResourceResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/shield.html#Shield.Client.list_tags_for_resource)
    ...
    def tag_resource(self, *, ResourceARN: str, Tags: List["TagTypeDef"]) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/shield.html#Shield.Client.tag_resource)
    ...
    def untag_resource(self, *, ResourceARN: str, TagKeys: List[str]) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/shield.html#Shield.Client.untag_resource)
    ...
    def update_emergency_contact_settings(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/shield.html#Shield.Client.update_emergency_contact_settings)
    ...
    def update_protection_group(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/shield.html#Shield.Client.update_protection_group)
    ...
    def update_subscription(self, *, AutoRenew: AutoRenewType = None) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/shield.html#Shield.Client.update_subscription)
    ...
    def get_paginator(self, operation_name: Literal["list_attacks"]) -> ListAttacksPaginator:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/shield.html#Shield.Paginator.ListAttacks)
    ...
    def get_paginator(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/shield.html#Shield.Paginator.ListProtections)
