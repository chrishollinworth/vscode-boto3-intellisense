...
class IVSClient(BaseClient):
    """
    [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/ivs.html#IVS.Client)
    ...
    def batch_get_channel(self, *, arns: List[str]) -> BatchGetChannelResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/ivs.html#IVS.Client.batch_get_channel)
    ...
    def batch_get_stream_key(self, *, arns: List[str]) -> BatchGetStreamKeyResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/ivs.html#IVS.Client.batch_get_stream_key)
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/ivs.html#IVS.Client.can_paginate)
    ...
    def create_channel(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/ivs.html#IVS.Client.create_channel)
    ...
    def create_recording_configuration(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/ivs.html#IVS.Client.create_recording_configuration)
    ...
    def create_stream_key(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/ivs.html#IVS.Client.create_stream_key)
    ...
    def delete_channel(self, *, arn: str) -> None:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/ivs.html#IVS.Client.delete_channel)
    ...
    def delete_playback_key_pair(self, *, arn: str) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/ivs.html#IVS.Client.delete_playback_key_pair)
    ...
    def delete_recording_configuration(self, *, arn: str) -> None:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/ivs.html#IVS.Client.delete_recording_configuration)
    ...
    def delete_stream_key(self, *, arn: str) -> None:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/ivs.html#IVS.Client.delete_stream_key)
    ...
    def generate_presigned_url(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/ivs.html#IVS.Client.generate_presigned_url)
    ...
    def get_channel(self, *, arn: str) -> GetChannelResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/ivs.html#IVS.Client.get_channel)
    ...
    def get_playback_key_pair(self, *, arn: str) -> GetPlaybackKeyPairResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/ivs.html#IVS.Client.get_playback_key_pair)
    ...
    def get_recording_configuration(self, *, arn: str) -> GetRecordingConfigurationResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/ivs.html#IVS.Client.get_recording_configuration)
    ...
    def get_stream(self, *, channelArn: str) -> GetStreamResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/ivs.html#IVS.Client.get_stream)
    ...
    def get_stream_key(self, *, arn: str) -> GetStreamKeyResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/ivs.html#IVS.Client.get_stream_key)
    ...
    def import_playback_key_pair(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/ivs.html#IVS.Client.import_playback_key_pair)
    ...
    def list_channels(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/ivs.html#IVS.Client.list_channels)
    ...
    def list_playback_key_pairs(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/ivs.html#IVS.Client.list_playback_key_pairs)
    ...
    def list_recording_configurations(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/ivs.html#IVS.Client.list_recording_configurations)
    ...
    def list_stream_keys(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/ivs.html#IVS.Client.list_stream_keys)
    ...
    def list_streams(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/ivs.html#IVS.Client.list_streams)
    ...
    def list_tags_for_resource(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/ivs.html#IVS.Client.list_tags_for_resource)
    ...
    def put_metadata(self, *, channelArn: str, metadata: str) -> None:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/ivs.html#IVS.Client.put_metadata)
    ...
    def stop_stream(self, *, channelArn: str) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/ivs.html#IVS.Client.stop_stream)
    ...
    def tag_resource(self, *, resourceArn: str, tags: Dict[str, str]) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/ivs.html#IVS.Client.tag_resource)
    ...
    def untag_resource(self, *, resourceArn: str, tagKeys: List[str]) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/ivs.html#IVS.Client.untag_resource)
    ...
    def update_channel(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/ivs.html#IVS.Client.update_channel)
    ...
    def get_paginator(self, operation_name: Literal["list_channels"]) -> ListChannelsPaginator:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/ivs.html#IVS.Paginator.ListChannels)
    ...
    def get_paginator(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/ivs.html#IVS.Paginator.ListPlaybackKeyPairs)
    ...
    def get_paginator(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/ivs.html#IVS.Paginator.ListRecordingConfigurations)
    ...
    def get_paginator(self, operation_name: Literal["list_stream_keys"]) -> ListStreamKeysPaginator:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/ivs.html#IVS.Paginator.ListStreamKeys)
    ...
    def get_paginator(self, operation_name: Literal["list_streams"]) -> ListStreamsPaginator:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/ivs.html#IVS.Paginator.ListStreams)
