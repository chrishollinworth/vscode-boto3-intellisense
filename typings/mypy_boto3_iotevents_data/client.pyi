...
class IoTEventsDataClient(BaseClient):
    """
    [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/iotevents-data.html#IoTEventsData.Client)
    ...
    def batch_acknowledge_alarm(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/iotevents-data.html#IoTEventsData.Client.batch_acknowledge_alarm)
    ...
    def batch_disable_alarm(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/iotevents-data.html#IoTEventsData.Client.batch_disable_alarm)
    ...
    def batch_enable_alarm(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/iotevents-data.html#IoTEventsData.Client.batch_enable_alarm)
    ...
    def batch_put_message(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/iotevents-data.html#IoTEventsData.Client.batch_put_message)
    ...
    def batch_reset_alarm(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/iotevents-data.html#IoTEventsData.Client.batch_reset_alarm)
    ...
    def batch_snooze_alarm(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/iotevents-data.html#IoTEventsData.Client.batch_snooze_alarm)
    ...
    def batch_update_detector(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/iotevents-data.html#IoTEventsData.Client.batch_update_detector)
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/iotevents-data.html#IoTEventsData.Client.can_paginate)
    ...
    def describe_alarm(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/iotevents-data.html#IoTEventsData.Client.describe_alarm)
    ...
    def describe_detector(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/iotevents-data.html#IoTEventsData.Client.describe_detector)
    ...
    def generate_presigned_url(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/iotevents-data.html#IoTEventsData.Client.generate_presigned_url)
    ...
    def list_alarms(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/iotevents-data.html#IoTEventsData.Client.list_alarms)
    ...
    def list_detectors(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/iotevents-data.html#IoTEventsData.Client.list_detectors)
