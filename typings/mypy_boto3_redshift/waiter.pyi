...
class ClusterAvailableWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [ClusterAvailable.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.14.47/reference/services/redshift.html#Redshift.Waiter.ClusterAvailable.wait)
        """
...
class ClusterDeletedWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [ClusterDeleted.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.14.47/reference/services/redshift.html#Redshift.Waiter.ClusterDeleted.wait)
        """
...
class ClusterRestoredWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [ClusterRestored.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.14.47/reference/services/redshift.html#Redshift.Waiter.ClusterRestored.wait)
        """
...
class SnapshotAvailableWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [SnapshotAvailable.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.14.47/reference/services/redshift.html#Redshift.Waiter.SnapshotAvailable.wait)
        """
