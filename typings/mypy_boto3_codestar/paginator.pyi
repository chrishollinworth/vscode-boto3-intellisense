...
class ListProjectsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListProjects.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.14.47/reference/services/codestar.html#CodeStar.Paginator.ListProjects.paginate)
        """
...
class ListResourcesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListResources.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.14.47/reference/services/codestar.html#CodeStar.Paginator.ListResources.paginate)
        """
...
class ListTeamMembersPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListTeamMembers.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.14.47/reference/services/codestar.html#CodeStar.Paginator.ListTeamMembers.paginate)
        """
...
class ListUserProfilesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListUserProfiles.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.14.47/reference/services/codestar.html#CodeStar.Paginator.ListUserProfiles.paginate)
        """
