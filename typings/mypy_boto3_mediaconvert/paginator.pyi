...
class DescribeEndpointsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [DescribeEndpoints.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.14.47/reference/services/mediaconvert.html#MediaConvert.Paginator.DescribeEndpoints.paginate)
        """
...
class ListJobTemplatesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListJobTemplates.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.14.47/reference/services/mediaconvert.html#MediaConvert.Paginator.ListJobTemplates.paginate)
        """
...
class ListJobsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListJobs.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.14.47/reference/services/mediaconvert.html#MediaConvert.Paginator.ListJobs.paginate)
        """
...
class ListPresetsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListPresets.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.14.47/reference/services/mediaconvert.html#MediaConvert.Paginator.ListPresets.paginate)
        """
...
class ListQueuesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListQueues.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.14.47/reference/services/mediaconvert.html#MediaConvert.Paginator.ListQueues.paginate)
        """
