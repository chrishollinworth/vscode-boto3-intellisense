...
class ListDeadLetterSourceQueuesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListDeadLetterSourceQueues.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.14.47/reference/services/sqs.html#SQS.Paginator.ListDeadLetterSourceQueues.paginate)
        """
...
class ListQueuesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListQueues.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.14.47/reference/services/sqs.html#SQS.Paginator.ListQueues.paginate)
        """
