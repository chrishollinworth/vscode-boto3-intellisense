...
class EnvironmentExistsWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [EnvironmentExists.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.14.47/reference/services/elasticbeanstalk.html#ElasticBeanstalk.Waiter.EnvironmentExists.wait)
        """
...
class EnvironmentTerminatedWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [EnvironmentTerminated.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.14.47/reference/services/elasticbeanstalk.html#ElasticBeanstalk.Waiter.EnvironmentTerminated.wait)
        """
...
class EnvironmentUpdatedWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [EnvironmentUpdated.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.14.47/reference/services/elasticbeanstalk.html#ElasticBeanstalk.Waiter.EnvironmentUpdated.wait)
        """
