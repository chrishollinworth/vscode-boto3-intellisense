...
class InspectorClient(BaseClient):
    """
    [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/inspector.html#Inspector.Client)
    ...
    def add_attributes_to_findings(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/inspector.html#Inspector.Client.add_attributes_to_findings)
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/inspector.html#Inspector.Client.can_paginate)
    ...
    def create_assessment_target(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/inspector.html#Inspector.Client.create_assessment_target)
    ...
    def create_assessment_template(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/inspector.html#Inspector.Client.create_assessment_template)
    ...
    def create_exclusions_preview(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/inspector.html#Inspector.Client.create_exclusions_preview)
    ...
    def create_resource_group(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/inspector.html#Inspector.Client.create_resource_group)
    ...
    def delete_assessment_run(self, *, assessmentRunArn: str) -> None:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/inspector.html#Inspector.Client.delete_assessment_run)
    ...
    def delete_assessment_target(self, *, assessmentTargetArn: str) -> None:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/inspector.html#Inspector.Client.delete_assessment_target)
    ...
    def delete_assessment_template(self, *, assessmentTemplateArn: str) -> None:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/inspector.html#Inspector.Client.delete_assessment_template)
    ...
    def describe_assessment_runs(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/inspector.html#Inspector.Client.describe_assessment_runs)
    ...
    def describe_assessment_targets(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/inspector.html#Inspector.Client.describe_assessment_targets)
    ...
    def describe_assessment_templates(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/inspector.html#Inspector.Client.describe_assessment_templates)
    ...
    def describe_cross_account_access_role(self) -> DescribeCrossAccountAccessRoleResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/inspector.html#Inspector.Client.describe_cross_account_access_role)
    ...
    def describe_exclusions(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/inspector.html#Inspector.Client.describe_exclusions)
    ...
    def describe_findings(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/inspector.html#Inspector.Client.describe_findings)
    ...
    def describe_resource_groups(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/inspector.html#Inspector.Client.describe_resource_groups)
    ...
    def describe_rules_packages(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/inspector.html#Inspector.Client.describe_rules_packages)
    ...
    def generate_presigned_url(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/inspector.html#Inspector.Client.generate_presigned_url)
    ...
    def get_assessment_report(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/inspector.html#Inspector.Client.get_assessment_report)
    ...
    def get_exclusions_preview(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/inspector.html#Inspector.Client.get_exclusions_preview)
    ...
    def get_telemetry_metadata(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/inspector.html#Inspector.Client.get_telemetry_metadata)
    ...
    def list_assessment_run_agents(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/inspector.html#Inspector.Client.list_assessment_run_agents)
    ...
    def list_assessment_runs(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/inspector.html#Inspector.Client.list_assessment_runs)
    ...
    def list_assessment_targets(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/inspector.html#Inspector.Client.list_assessment_targets)
    ...
    def list_assessment_templates(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/inspector.html#Inspector.Client.list_assessment_templates)
    ...
    def list_event_subscriptions(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/inspector.html#Inspector.Client.list_event_subscriptions)
    ...
    def list_exclusions(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/inspector.html#Inspector.Client.list_exclusions)
    ...
    def list_findings(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/inspector.html#Inspector.Client.list_findings)
    ...
    def list_rules_packages(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/inspector.html#Inspector.Client.list_rules_packages)
    ...
    def list_tags_for_resource(self, *, resourceArn: str) -> ListTagsForResourceResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/inspector.html#Inspector.Client.list_tags_for_resource)
    ...
    def preview_agents(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/inspector.html#Inspector.Client.preview_agents)
    ...
    def register_cross_account_access_role(self, *, roleArn: str) -> None:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/inspector.html#Inspector.Client.register_cross_account_access_role)
    ...
    def remove_attributes_from_findings(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/inspector.html#Inspector.Client.remove_attributes_from_findings)
    ...
    def set_tags_for_resource(self, *, resourceArn: str, tags: List["TagTypeDef"] = None) -> None:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/inspector.html#Inspector.Client.set_tags_for_resource)
    ...
    def start_assessment_run(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/inspector.html#Inspector.Client.start_assessment_run)
    ...
    def stop_assessment_run(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/inspector.html#Inspector.Client.stop_assessment_run)
    ...
    def subscribe_to_event(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/inspector.html#Inspector.Client.subscribe_to_event)
    ...
    def unsubscribe_from_event(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/inspector.html#Inspector.Client.unsubscribe_from_event)
    ...
    def update_assessment_target(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/inspector.html#Inspector.Client.update_assessment_target)
    ...
    def get_paginator(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/inspector.html#Inspector.Paginator.ListAssessmentRunAgents)
    ...
    def get_paginator(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/inspector.html#Inspector.Paginator.ListAssessmentRuns)
    ...
    def get_paginator(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/inspector.html#Inspector.Paginator.ListAssessmentTargets)
    ...
    def get_paginator(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/inspector.html#Inspector.Paginator.ListAssessmentTemplates)
    ...
    def get_paginator(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/inspector.html#Inspector.Paginator.ListEventSubscriptions)
    ...
    def get_paginator(self, operation_name: Literal["list_exclusions"]) -> ListExclusionsPaginator:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/inspector.html#Inspector.Paginator.ListExclusions)
    ...
    def get_paginator(self, operation_name: Literal["list_findings"]) -> ListFindingsPaginator:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/inspector.html#Inspector.Paginator.ListFindings)
    ...
    def get_paginator(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/inspector.html#Inspector.Paginator.ListRulesPackages)
    ...
    def get_paginator(self, operation_name: Literal["preview_agents"]) -> PreviewAgentsPaginator:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/inspector.html#Inspector.Paginator.PreviewAgents)
