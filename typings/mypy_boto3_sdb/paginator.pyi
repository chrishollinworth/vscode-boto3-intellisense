...
class ListDomainsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListDomains.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.14.47/reference/services/sdb.html#SimpleDB.Paginator.ListDomains.paginate)
        """
...
class SelectPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [Select.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.14.47/reference/services/sdb.html#SimpleDB.Paginator.Select.paginate)
        """
