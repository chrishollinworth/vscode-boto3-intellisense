...
class DescribeAlarmHistoryPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [DescribeAlarmHistory.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.14.47/reference/services/cloudwatch.html#CloudWatch.Paginator.DescribeAlarmHistory.paginate)
        """
...
class DescribeAlarmsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [DescribeAlarms.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.14.47/reference/services/cloudwatch.html#CloudWatch.Paginator.DescribeAlarms.paginate)
        """
...
class GetMetricDataPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [GetMetricData.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.14.47/reference/services/cloudwatch.html#CloudWatch.Paginator.GetMetricData.paginate)
        """
...
class ListDashboardsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListDashboards.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.14.47/reference/services/cloudwatch.html#CloudWatch.Paginator.ListDashboards.paginate)
        """
...
class ListMetricsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListMetrics.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.14.47/reference/services/cloudwatch.html#CloudWatch.Paginator.ListMetrics.paginate)
        """
