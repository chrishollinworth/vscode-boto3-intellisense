...
class ListRuleNamesByTargetPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListRuleNamesByTarget.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.20/reference/services/events.html#EventBridge.Paginator.ListRuleNamesByTarget.paginate)
        """
...
class ListRulesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListRules.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.20/reference/services/events.html#EventBridge.Paginator.ListRules.paginate)
        """
...
class ListTargetsByRulePaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListTargetsByRule.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.20/reference/services/events.html#EventBridge.Paginator.ListTargetsByRule.paginate)
        """
