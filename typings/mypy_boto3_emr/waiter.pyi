...
class ClusterRunningWaiter(Boto3Waiter):
    ...
    def wait(self, ClusterId: str, WaiterConfig: WaiterConfigTypeDef = None) -> None:
        """
        [ClusterRunning.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.14.47/reference/services/emr.html#EMR.Waiter.ClusterRunning.wait)
        """
...
class ClusterTerminatedWaiter(Boto3Waiter):
    ...
    def wait(self, ClusterId: str, WaiterConfig: WaiterConfigTypeDef = None) -> None:
        """
        [ClusterTerminated.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.14.47/reference/services/emr.html#EMR.Waiter.ClusterTerminated.wait)
        """
...
class StepCompleteWaiter(Boto3Waiter):
    ...
    def wait(self, ClusterId: str, StepId: str, WaiterConfig: WaiterConfigTypeDef = None) -> None:
        """
        [StepComplete.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.14.47/reference/services/emr.html#EMR.Waiter.StepComplete.wait)
        """
