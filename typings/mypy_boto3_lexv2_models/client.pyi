...
class LexModelsV2Client(BaseClient):
    ...
    def create_intent(
        ...
        *,
        ...
        qnAIntentConfiguration: "QnAIntentConfigurationTypeDef" = None
    ) -> CreateIntentResponseTypeDef:
        """
        Creates an intent.
    ...
    def list_bot_alias_replicas(
        self, *, botId: str, replicaRegion: str, maxResults: int = None, nextToken: str = None
    ) -> ListBotAliasReplicasResponseTypeDef:
        """
    ...
    def list_bot_version_replicas(
        ...
        *,
        ...
        maxResults: int = None,
        nextToken: str = None,
        sortBy: "BotVersionReplicaSortByTypeDef" = None
    ) -> ListBotVersionReplicasResponseTypeDef:
        """
