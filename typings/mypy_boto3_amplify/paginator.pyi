...
class ListAppsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListApps.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.20/reference/services/amplify.html#Amplify.Paginator.ListApps.paginate)
        """
...
class ListBranchesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListBranches.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.20/reference/services/amplify.html#Amplify.Paginator.ListBranches.paginate)
        """
...
class ListDomainAssociationsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListDomainAssociations.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.20/reference/services/amplify.html#Amplify.Paginator.ListDomainAssociations.paginate)
        """
...
class ListJobsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListJobs.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.16.20/reference/services/amplify.html#Amplify.Paginator.ListJobs.paginate)
        """
