...
class ListDetectorsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListDetectors.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.14.47/reference/services/guardduty.html#GuardDuty.Paginator.ListDetectors.paginate)
        """
...
class ListFiltersPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListFilters.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.14.47/reference/services/guardduty.html#GuardDuty.Paginator.ListFilters.paginate)
        """
...
class ListFindingsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListFindings.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.14.47/reference/services/guardduty.html#GuardDuty.Paginator.ListFindings.paginate)
        """
...
class ListIPSetsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListIPSets.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.14.47/reference/services/guardduty.html#GuardDuty.Paginator.ListIPSets.paginate)
        """
...
class ListInvitationsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListInvitations.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.14.47/reference/services/guardduty.html#GuardDuty.Paginator.ListInvitations.paginate)
        """
...
class ListMembersPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListMembers.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.14.47/reference/services/guardduty.html#GuardDuty.Paginator.ListMembers.paginate)
        """
...
class ListOrganizationAdminAccountsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListOrganizationAdminAccounts.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.14.47/reference/services/guardduty.html#GuardDuty.Paginator.ListOrganizationAdminAccounts.paginate)
        """
...
class ListThreatIntelSetsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListThreatIntelSets.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.14.47/reference/services/guardduty.html#GuardDuty.Paginator.ListThreatIntelSets.paginate)
        """
