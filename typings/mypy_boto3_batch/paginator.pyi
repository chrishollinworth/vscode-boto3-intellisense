...
class DescribeComputeEnvironmentsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [DescribeComputeEnvironments.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.14.47/reference/services/batch.html#Batch.Paginator.DescribeComputeEnvironments.paginate)
        """
...
class DescribeJobDefinitionsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [DescribeJobDefinitions.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.14.47/reference/services/batch.html#Batch.Paginator.DescribeJobDefinitions.paginate)
        """
...
class DescribeJobQueuesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [DescribeJobQueues.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.14.47/reference/services/batch.html#Batch.Paginator.DescribeJobQueues.paginate)
        """
...
class ListJobsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListJobs.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.14.47/reference/services/batch.html#Batch.Paginator.ListJobs.paginate)
        """
