...
class KafkaClient(BaseClient):
    """
    [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/kafka.html#Kafka.Client)
    ...
    def batch_associate_scram_secret(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/kafka.html#Kafka.Client.batch_associate_scram_secret)
    ...
    def batch_disassociate_scram_secret(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/kafka.html#Kafka.Client.batch_disassociate_scram_secret)
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/kafka.html#Kafka.Client.can_paginate)
    ...
    def create_cluster(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/kafka.html#Kafka.Client.create_cluster)
    ...
    def create_configuration(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/kafka.html#Kafka.Client.create_configuration)
    ...
    def delete_cluster(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/kafka.html#Kafka.Client.delete_cluster)
    ...
    def delete_configuration(self, *, Arn: str) -> DeleteConfigurationResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/kafka.html#Kafka.Client.delete_configuration)
    ...
    def describe_cluster(self, *, ClusterArn: str) -> DescribeClusterResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/kafka.html#Kafka.Client.describe_cluster)
    ...
    def describe_cluster_operation(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/kafka.html#Kafka.Client.describe_cluster_operation)
    ...
    def describe_configuration(self, *, Arn: str) -> DescribeConfigurationResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/kafka.html#Kafka.Client.describe_configuration)
    ...
    def describe_configuration_revision(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/kafka.html#Kafka.Client.describe_configuration_revision)
    ...
    def generate_presigned_url(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/kafka.html#Kafka.Client.generate_presigned_url)
    ...
    def get_bootstrap_brokers(self, *, ClusterArn: str) -> GetBootstrapBrokersResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/kafka.html#Kafka.Client.get_bootstrap_brokers)
    ...
    def get_compatible_kafka_versions(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/kafka.html#Kafka.Client.get_compatible_kafka_versions)
    ...
    def list_cluster_operations(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/kafka.html#Kafka.Client.list_cluster_operations)
    ...
    def list_clusters(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/kafka.html#Kafka.Client.list_clusters)
    ...
    def list_configuration_revisions(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/kafka.html#Kafka.Client.list_configuration_revisions)
    ...
    def list_configurations(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/kafka.html#Kafka.Client.list_configurations)
    ...
    def list_kafka_versions(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/kafka.html#Kafka.Client.list_kafka_versions)
    ...
    def list_nodes(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/kafka.html#Kafka.Client.list_nodes)
    ...
    def list_scram_secrets(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/kafka.html#Kafka.Client.list_scram_secrets)
    ...
    def list_tags_for_resource(self, *, ResourceArn: str) -> ListTagsForResourceResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/kafka.html#Kafka.Client.list_tags_for_resource)
    ...
    def reboot_broker(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/kafka.html#Kafka.Client.reboot_broker)
    ...
    def tag_resource(self, *, ResourceArn: str, Tags: Dict[str, str]) -> None:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/kafka.html#Kafka.Client.tag_resource)
    ...
    def untag_resource(self, *, ResourceArn: str, TagKeys: List[str]) -> None:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/kafka.html#Kafka.Client.untag_resource)
    ...
    def update_broker_count(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/kafka.html#Kafka.Client.update_broker_count)
    ...
    def update_broker_storage(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/kafka.html#Kafka.Client.update_broker_storage)
    ...
    def update_broker_type(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/kafka.html#Kafka.Client.update_broker_type)
    ...
    def update_cluster_configuration(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/kafka.html#Kafka.Client.update_cluster_configuration)
    ...
    def update_cluster_kafka_version(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/kafka.html#Kafka.Client.update_cluster_kafka_version)
    ...
    def update_configuration(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/kafka.html#Kafka.Client.update_configuration)
    ...
    def update_monitoring(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/kafka.html#Kafka.Client.update_monitoring)
    ...
    def get_paginator(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/kafka.html#Kafka.Paginator.ListClusterOperations)
    ...
    def get_paginator(self, operation_name: Literal["list_clusters"]) -> ListClustersPaginator:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/kafka.html#Kafka.Paginator.ListClusters)
    ...
    def get_paginator(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/kafka.html#Kafka.Paginator.ListConfigurationRevisions)
    ...
    def get_paginator(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/kafka.html#Kafka.Paginator.ListConfigurations)
    ...
    def get_paginator(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/kafka.html#Kafka.Paginator.ListKafkaVersions)
    ...
    def get_paginator(self, operation_name: Literal["list_nodes"]) -> ListNodesPaginator:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/kafka.html#Kafka.Paginator.ListNodes)
    ...
    def get_paginator(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/kafka.html#Kafka.Paginator.ListScramSecrets)
