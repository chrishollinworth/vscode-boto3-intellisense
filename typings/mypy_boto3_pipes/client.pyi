...
class EventBridgePipesClient(BaseClient):
    """
    [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.26.45/reference/services/pipes.html#EventBridgePipes.Client)
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.26.45/reference/services/pipes.html#EventBridgePipes.Client.can_paginate)
    ...
    def close(self) -> None:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.26.45/reference/services/pipes.html#EventBridgePipes.Client.close)
    ...
    def create_pipe(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.26.45/reference/services/pipes.html#EventBridgePipes.Client.create_pipe)
    ...
    def delete_pipe(self, *, Name: str) -> DeletePipeResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.26.45/reference/services/pipes.html#EventBridgePipes.Client.delete_pipe)
    ...
    def describe_pipe(self, *, Name: str) -> DescribePipeResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.26.45/reference/services/pipes.html#EventBridgePipes.Client.describe_pipe)
    ...
    def generate_presigned_url(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.26.45/reference/services/pipes.html#EventBridgePipes.Client.generate_presigned_url)
    ...
    def list_pipes(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.26.45/reference/services/pipes.html#EventBridgePipes.Client.list_pipes)
    ...
    def list_tags_for_resource(self, *, resourceArn: str) -> ListTagsForResourceResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.26.45/reference/services/pipes.html#EventBridgePipes.Client.list_tags_for_resource)
    ...
    def start_pipe(self, *, Name: str) -> StartPipeResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.26.45/reference/services/pipes.html#EventBridgePipes.Client.start_pipe)
    ...
    def stop_pipe(self, *, Name: str) -> StopPipeResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.26.45/reference/services/pipes.html#EventBridgePipes.Client.stop_pipe)
    ...
    def tag_resource(self, *, resourceArn: str, tags: Dict[str, str]) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.26.45/reference/services/pipes.html#EventBridgePipes.Client.tag_resource)
    ...
    def untag_resource(self, *, resourceArn: str, tagKeys: List[str]) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.26.45/reference/services/pipes.html#EventBridgePipes.Client.untag_resource)
    ...
    def update_pipe(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.26.45/reference/services/pipes.html#EventBridgePipes.Client.update_pipe)
    ...
    def get_paginator(self, operation_name: Literal["list_pipes"]) -> ListPipesPaginator:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.26.45/reference/services/pipes.html#EventBridgePipes.Paginator.ListPipes)
