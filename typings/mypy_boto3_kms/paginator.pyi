...
class ListAliasesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListAliases.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.14.47/reference/services/kms.html#KMS.Paginator.ListAliases.paginate)
        """
...
class ListGrantsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListGrants.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.14.47/reference/services/kms.html#KMS.Paginator.ListGrants.paginate)
        """
...
class ListKeyPoliciesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListKeyPolicies.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.14.47/reference/services/kms.html#KMS.Paginator.ListKeyPolicies.paginate)
        """
...
class ListKeysPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListKeys.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.14.47/reference/services/kms.html#KMS.Paginator.ListKeys.paginate)
        """
