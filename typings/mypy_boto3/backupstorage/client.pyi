...
class BackupStorageClient(BaseClient):
    """
    [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.24.58/reference/services/backupstorage.html#BackupStorage.Client)
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.24.58/reference/services/backupstorage.html#BackupStorage.Client.can_paginate)
    ...
    def close(self) -> None:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.24.58/reference/services/backupstorage.html#BackupStorage.Client.close)
    ...
    def delete_object(self, *, BackupJobId: str, ObjectName: str) -> None:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.24.58/reference/services/backupstorage.html#BackupStorage.Client.delete_object)
    ...
    def generate_presigned_url(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.24.58/reference/services/backupstorage.html#BackupStorage.Client.generate_presigned_url)
    ...
    def get_chunk(self, *, StorageJobId: str, ChunkToken: str) -> GetChunkOutputTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.24.58/reference/services/backupstorage.html#BackupStorage.Client.get_chunk)
    ...
    def get_object_metadata(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.24.58/reference/services/backupstorage.html#BackupStorage.Client.get_object_metadata)
    ...
    def list_chunks(
        ...
        **Request Syntax** response = client.list_chunks( StorageJobId='string',
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.24.58/reference/services/backupstorage.html#BackupStorage.Client.list_chunks)
    ...
    def list_objects(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.24.58/reference/services/backupstorage.html#BackupStorage.Client.list_objects)
    ...
    def notify_object_complete(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.24.58/reference/services/backupstorage.html#BackupStorage.Client.notify_object_complete)
    ...
    def put_chunk(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.24.58/reference/services/backupstorage.html#BackupStorage.Client.put_chunk)
    ...
    def put_object(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.24.58/reference/services/backupstorage.html#BackupStorage.Client.put_object)
    ...
    def start_object(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.24.58/reference/services/backupstorage.html#BackupStorage.Client.start_object)
