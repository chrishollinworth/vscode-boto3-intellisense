...
class KinesisVideoClient(BaseClient):
    """
    [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/kinesisvideo.html#KinesisVideo.Client)
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/kinesisvideo.html#KinesisVideo.Client.can_paginate)
    ...
    def create_signaling_channel(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/kinesisvideo.html#KinesisVideo.Client.create_signaling_channel)
    ...
    def create_stream(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/kinesisvideo.html#KinesisVideo.Client.create_stream)
    ...
    def delete_signaling_channel(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/kinesisvideo.html#KinesisVideo.Client.delete_signaling_channel)
    ...
    def delete_stream(self, *, StreamARN: str, CurrentVersion: str = None) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/kinesisvideo.html#KinesisVideo.Client.delete_stream)
    ...
    def describe_signaling_channel(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/kinesisvideo.html#KinesisVideo.Client.describe_signaling_channel)
    ...
    def describe_stream(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/kinesisvideo.html#KinesisVideo.Client.describe_stream)
    ...
    def generate_presigned_url(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/kinesisvideo.html#KinesisVideo.Client.generate_presigned_url)
    ...
    def get_data_endpoint(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/kinesisvideo.html#KinesisVideo.Client.get_data_endpoint)
    ...
    def get_signaling_channel_endpoint(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/kinesisvideo.html#KinesisVideo.Client.get_signaling_channel_endpoint)
    ...
    def list_signaling_channels(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/kinesisvideo.html#KinesisVideo.Client.list_signaling_channels)
    ...
    def list_streams(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/kinesisvideo.html#KinesisVideo.Client.list_streams)
    ...
    def list_tags_for_resource(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/kinesisvideo.html#KinesisVideo.Client.list_tags_for_resource)
    ...
    def list_tags_for_stream(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/kinesisvideo.html#KinesisVideo.Client.list_tags_for_stream)
    ...
    def tag_resource(self, *, ResourceARN: str, Tags: List["TagTypeDef"]) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/kinesisvideo.html#KinesisVideo.Client.tag_resource)
    ...
    def tag_stream(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/kinesisvideo.html#KinesisVideo.Client.tag_stream)
    ...
    def untag_resource(self, *, ResourceARN: str, TagKeyList: List[str]) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/kinesisvideo.html#KinesisVideo.Client.untag_resource)
    ...
    def untag_stream(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/kinesisvideo.html#KinesisVideo.Client.untag_stream)
    ...
    def update_data_retention(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/kinesisvideo.html#KinesisVideo.Client.update_data_retention)
    ...
    def update_signaling_channel(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/kinesisvideo.html#KinesisVideo.Client.update_signaling_channel)
    ...
    def update_stream(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/kinesisvideo.html#KinesisVideo.Client.update_stream)
    ...
    def get_paginator(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/kinesisvideo.html#KinesisVideo.Paginator.ListSignalingChannels)
    ...
    def get_paginator(self, operation_name: Literal["list_streams"]) -> ListStreamsPaginator:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/kinesisvideo.html#KinesisVideo.Paginator.ListStreams)
