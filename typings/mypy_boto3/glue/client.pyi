...
class GlueClient(BaseClient):
    ...
    def get_unfiltered_partition_metadata(
        ...
        *,
        ...
        """
        See also: `AWS API Documentation <https://docs.aws.amazon.com/goto/WebAPI/glue-2
        017-03-31/GetUnfilteredPartitionMetadata>`_ **Request Syntax** response =
    ...
    def get_unfiltered_partitions_metadata(
        ...
        *,
        ...
        """
        See also: `AWS API Documentation <https://docs.aws.amazon.com/goto/WebAPI/glue-2
        017-03-31/GetUnfilteredPartitionsMetadata>`_ **Request Syntax** response =
    ...
    def get_unfiltered_table_metadata(
        ...
        *,
        ...
        """
        See also: `AWS API Documentation <https://docs.aws.amazon.com/goto/WebAPI/glue-2
        017-03-31/GetUnfilteredTableMetadata>`_ **Request Syntax** response =
