...
class MediaPackageClient(BaseClient):
    """
    [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mediapackage.html#MediaPackage.Client)
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mediapackage.html#MediaPackage.Client.can_paginate)
    ...
    def configure_logs(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mediapackage.html#MediaPackage.Client.configure_logs)
    ...
    def create_channel(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mediapackage.html#MediaPackage.Client.create_channel)
    ...
    def create_harvest_job(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mediapackage.html#MediaPackage.Client.create_harvest_job)
    ...
    def create_origin_endpoint(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mediapackage.html#MediaPackage.Client.create_origin_endpoint)
    ...
    def delete_channel(self, *, Id: str) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mediapackage.html#MediaPackage.Client.delete_channel)
    ...
    def delete_origin_endpoint(self, *, Id: str) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mediapackage.html#MediaPackage.Client.delete_origin_endpoint)
    ...
    def describe_channel(self, *, Id: str) -> DescribeChannelResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mediapackage.html#MediaPackage.Client.describe_channel)
    ...
    def describe_harvest_job(self, *, Id: str) -> DescribeHarvestJobResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mediapackage.html#MediaPackage.Client.describe_harvest_job)
    ...
    def describe_origin_endpoint(self, *, Id: str) -> DescribeOriginEndpointResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mediapackage.html#MediaPackage.Client.describe_origin_endpoint)
    ...
    def generate_presigned_url(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mediapackage.html#MediaPackage.Client.generate_presigned_url)
    ...
    def list_channels(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mediapackage.html#MediaPackage.Client.list_channels)
    ...
    def list_harvest_jobs(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mediapackage.html#MediaPackage.Client.list_harvest_jobs)
    ...
    def list_origin_endpoints(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mediapackage.html#MediaPackage.Client.list_origin_endpoints)
    ...
    def list_tags_for_resource(self, *, ResourceArn: str) -> ListTagsForResourceResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mediapackage.html#MediaPackage.Client.list_tags_for_resource)
    ...
    def rotate_channel_credentials(self, *, Id: str) -> RotateChannelCredentialsResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mediapackage.html#MediaPackage.Client.rotate_channel_credentials)
    ...
    def rotate_ingest_endpoint_credentials(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mediapackage.html#MediaPackage.Client.rotate_ingest_endpoint_credentials)
    ...
    def tag_resource(self, *, ResourceArn: str, Tags: Dict[str, str]) -> None:
        ...
        **Request Syntax** response = client.tag_resource( ResourceArn='string', Tags={
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mediapackage.html#MediaPackage.Client.tag_resource)
    ...
    def untag_resource(self, *, ResourceArn: str, TagKeys: List[str]) -> None:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mediapackage.html#MediaPackage.Client.untag_resource)
    ...
    def update_channel(self, *, Id: str, Description: str = None) -> UpdateChannelResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mediapackage.html#MediaPackage.Client.update_channel)
    ...
    def update_origin_endpoint(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mediapackage.html#MediaPackage.Client.update_origin_endpoint)
    ...
    def get_paginator(self, operation_name: Literal["list_channels"]) -> ListChannelsPaginator:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mediapackage.html#MediaPackage.Paginator.ListChannels)
    ...
    def get_paginator(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mediapackage.html#MediaPackage.Paginator.ListHarvestJobs)
    ...
    def get_paginator(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mediapackage.html#MediaPackage.Paginator.ListOriginEndpoints)
