...
class MediaConnectClient(BaseClient):
    """
    [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mediaconnect.html#MediaConnect.Client)
    ...
    def add_flow_media_streams(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mediaconnect.html#MediaConnect.Client.add_flow_media_streams)
    ...
    def add_flow_outputs(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mediaconnect.html#MediaConnect.Client.add_flow_outputs)
    ...
    def add_flow_sources(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mediaconnect.html#MediaConnect.Client.add_flow_sources)
    ...
    def add_flow_vpc_interfaces(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mediaconnect.html#MediaConnect.Client.add_flow_vpc_interfaces)
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mediaconnect.html#MediaConnect.Client.can_paginate)
    ...
    def create_flow(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mediaconnect.html#MediaConnect.Client.create_flow)
    ...
    def delete_flow(self, *, FlowArn: str) -> DeleteFlowResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mediaconnect.html#MediaConnect.Client.delete_flow)
    ...
    def describe_flow(self, *, FlowArn: str) -> DescribeFlowResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mediaconnect.html#MediaConnect.Client.describe_flow)
    ...
    def describe_offering(self, *, OfferingArn: str) -> DescribeOfferingResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mediaconnect.html#MediaConnect.Client.describe_offering)
    ...
    def describe_reservation(self, *, ReservationArn: str) -> DescribeReservationResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mediaconnect.html#MediaConnect.Client.describe_reservation)
    ...
    def generate_presigned_url(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mediaconnect.html#MediaConnect.Client.generate_presigned_url)
    ...
    def grant_flow_entitlements(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mediaconnect.html#MediaConnect.Client.grant_flow_entitlements)
    ...
    def list_entitlements(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mediaconnect.html#MediaConnect.Client.list_entitlements)
    ...
    def list_flows(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mediaconnect.html#MediaConnect.Client.list_flows)
    ...
    def list_offerings(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mediaconnect.html#MediaConnect.Client.list_offerings)
    ...
    def list_reservations(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mediaconnect.html#MediaConnect.Client.list_reservations)
    ...
    def list_tags_for_resource(self, *, ResourceArn: str) -> ListTagsForResourceResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mediaconnect.html#MediaConnect.Client.list_tags_for_resource)
    ...
    def purchase_offering(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mediaconnect.html#MediaConnect.Client.purchase_offering)
    ...
    def remove_flow_media_stream(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mediaconnect.html#MediaConnect.Client.remove_flow_media_stream)
    ...
    def remove_flow_output(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mediaconnect.html#MediaConnect.Client.remove_flow_output)
    ...
    def remove_flow_source(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mediaconnect.html#MediaConnect.Client.remove_flow_source)
    ...
    def remove_flow_vpc_interface(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mediaconnect.html#MediaConnect.Client.remove_flow_vpc_interface)
    ...
    def revoke_flow_entitlement(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mediaconnect.html#MediaConnect.Client.revoke_flow_entitlement)
    ...
    def start_flow(self, *, FlowArn: str) -> StartFlowResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mediaconnect.html#MediaConnect.Client.start_flow)
    ...
    def stop_flow(self, *, FlowArn: str) -> StopFlowResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mediaconnect.html#MediaConnect.Client.stop_flow)
    ...
    def tag_resource(self, *, ResourceArn: str, Tags: Dict[str, str]) -> None:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mediaconnect.html#MediaConnect.Client.tag_resource)
    ...
    def untag_resource(self, *, ResourceArn: str, TagKeys: List[str]) -> None:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mediaconnect.html#MediaConnect.Client.untag_resource)
    ...
    def update_flow(
        ...
        **Request Syntax** response = client.update_flow( FlowArn='string',
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mediaconnect.html#MediaConnect.Client.update_flow)
    ...
    def update_flow_entitlement(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mediaconnect.html#MediaConnect.Client.update_flow_entitlement)
    ...
    def update_flow_media_stream(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mediaconnect.html#MediaConnect.Client.update_flow_media_stream)
    ...
    def update_flow_output(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mediaconnect.html#MediaConnect.Client.update_flow_output)
    ...
    def update_flow_source(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mediaconnect.html#MediaConnect.Client.update_flow_source)
    ...
    def get_paginator(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mediaconnect.html#MediaConnect.Paginator.ListEntitlements)
    ...
    def get_paginator(self, operation_name: Literal["list_flows"]) -> ListFlowsPaginator:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mediaconnect.html#MediaConnect.Paginator.ListFlows)
    ...
    def get_paginator(self, operation_name: Literal["list_offerings"]) -> ListOfferingsPaginator:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mediaconnect.html#MediaConnect.Paginator.ListOfferings)
    ...
    def get_paginator(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mediaconnect.html#MediaConnect.Paginator.ListReservations)
    ...
    def get_waiter(self, waiter_name: Literal["flow_active"]) -> FlowActiveWaiter:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mediaconnect.html#MediaConnect.Waiter.FlowActive)
    ...
    def get_waiter(self, waiter_name: Literal["flow_deleted"]) -> FlowDeletedWaiter:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mediaconnect.html#MediaConnect.Waiter.FlowDeleted)
    ...
    def get_waiter(self, waiter_name: Literal["flow_standby"]) -> FlowStandbyWaiter:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mediaconnect.html#MediaConnect.Waiter.FlowStandby)
