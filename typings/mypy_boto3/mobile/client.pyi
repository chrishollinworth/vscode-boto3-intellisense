...
class MobileClient(BaseClient):
    """
    [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mobile.html#Mobile.Client)
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mobile.html#Mobile.Client.can_paginate)
    ...
    def create_project(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mobile.html#Mobile.Client.create_project)
    ...
    def delete_project(self, *, projectId: str) -> DeleteProjectResultTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mobile.html#Mobile.Client.delete_project)
    ...
    def describe_bundle(self, *, bundleId: str) -> DescribeBundleResultTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mobile.html#Mobile.Client.describe_bundle)
    ...
    def describe_project(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mobile.html#Mobile.Client.describe_project)
    ...
    def export_bundle(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mobile.html#Mobile.Client.export_bundle)
    ...
    def export_project(self, *, projectId: str) -> ExportProjectResultTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mobile.html#Mobile.Client.export_project)
    ...
    def generate_presigned_url(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mobile.html#Mobile.Client.generate_presigned_url)
    ...
    def list_bundles(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mobile.html#Mobile.Client.list_bundles)
    ...
    def list_projects(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mobile.html#Mobile.Client.list_projects)
    ...
    def update_project(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mobile.html#Mobile.Client.update_project)
    ...
    def get_paginator(self, operation_name: Literal["list_bundles"]) -> ListBundlesPaginator:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mobile.html#Mobile.Paginator.ListBundles)
    ...
    def get_paginator(self, operation_name: Literal["list_projects"]) -> ListProjectsPaginator:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mobile.html#Mobile.Paginator.ListProjects)
