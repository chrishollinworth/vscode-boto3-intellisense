...
_RequiredGetServiceQuotaRequestRequestTypeDef = TypedDict(
    "_RequiredGetServiceQuotaRequestRequestTypeDef",
    {
        "ServiceCode": str,
        "QuotaCode": str,
    },
)
_OptionalGetServiceQuotaRequestRequestTypeDef = TypedDict(
    "_OptionalGetServiceQuotaRequestRequestTypeDef",
    {
        "ContextId": str,
    },
    total=False,
...
class GetServiceQuotaRequestRequestTypeDef(
    _RequiredGetServiceQuotaRequestRequestTypeDef, _OptionalGetServiceQuotaRequestRequestTypeDef
):
    pass
...
QuotaContextInfoTypeDef = TypedDict(
    "QuotaContextInfoTypeDef",
    {
        "ContextScope": QuotaContextScopeType,
        "ContextScopeType": str,
        "ContextId": str,
    },
    total=False,
)
...
_RequiredRequestServiceQuotaIncreaseRequestRequestTypeDef = TypedDict(
    "_RequiredRequestServiceQuotaIncreaseRequestRequestTypeDef",
    {
        "ServiceCode": str,
        "QuotaCode": str,
        "DesiredValue": float,
...
_OptionalRequestServiceQuotaIncreaseRequestRequestTypeDef = TypedDict(
    "_OptionalRequestServiceQuotaIncreaseRequestRequestTypeDef",
    {
        "ContextId": str,
    },
    total=False,
...
class RequestServiceQuotaIncreaseRequestRequestTypeDef(
    _RequiredRequestServiceQuotaIncreaseRequestRequestTypeDef,
    _OptionalRequestServiceQuotaIncreaseRequestRequestTypeDef,
):
    pass
...
RequestedServiceQuotaChangeTypeDef = TypedDict(
    "RequestedServiceQuotaChangeTypeDef",
    {
        ...
        "Unit": str,
        "QuotaRequestedAtLevel": AppliedLevelEnumType,
        "QuotaContext": "QuotaContextInfoTypeDef",
    },
    total=False,
)
