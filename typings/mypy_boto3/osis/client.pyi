...
class OpenSearchIngestionClient(BaseClient):
    """
    [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.26.121/reference/services/osis.html#OpenSearchIngestion.Client)
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.26.121/reference/services/osis.html#OpenSearchIngestion.Client.can_paginate)
    ...
    def close(self) -> None:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.26.121/reference/services/osis.html#OpenSearchIngestion.Client.close)
    ...
    def create_pipeline(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.26.121/reference/services/osis.html#OpenSearchIngestion.Client.create_pipeline)
    ...
    def delete_pipeline(self, *, PipelineName: str) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.26.121/reference/services/osis.html#OpenSearchIngestion.Client.delete_pipeline)
    ...
    def generate_presigned_url(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.26.121/reference/services/osis.html#OpenSearchIngestion.Client.generate_presigned_url)
    ...
    def get_pipeline(self, *, PipelineName: str) -> GetPipelineResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.26.121/reference/services/osis.html#OpenSearchIngestion.Client.get_pipeline)
        [Show boto3-stubs documentation](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_osis/client.html#get_pipeline)
        """
    def get_pipeline_blueprint(self, *, BlueprintName: str) -> GetPipelineBlueprintResponseTypeDef:
        """
        Retrieves information about a specific blueprint for OpenSearch Ingestion.

        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.26.121/reference/services/osis.html#OpenSearchIngestion.Client.get_pipeline_blueprint)
    ...
    def get_pipeline_change_progress(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.26.121/reference/services/osis.html#OpenSearchIngestion.Client.get_pipeline_change_progress)
    ...
    def list_pipeline_blueprints(self) -> ListPipelineBlueprintsResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.26.121/reference/services/osis.html#OpenSearchIngestion.Client.list_pipeline_blueprints)
    ...
    def list_pipelines(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.26.121/reference/services/osis.html#OpenSearchIngestion.Client.list_pipelines)
    ...
    def list_tags_for_resource(self, *, Arn: str) -> ListTagsForResourceResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.26.121/reference/services/osis.html#OpenSearchIngestion.Client.list_tags_for_resource)
    ...
    def start_pipeline(self, *, PipelineName: str) -> StartPipelineResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.26.121/reference/services/osis.html#OpenSearchIngestion.Client.start_pipeline)
    ...
    def stop_pipeline(self, *, PipelineName: str) -> StopPipelineResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.26.121/reference/services/osis.html#OpenSearchIngestion.Client.stop_pipeline)
    ...
    def tag_resource(self, *, Arn: str, Tags: List["TagTypeDef"]) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.26.121/reference/services/osis.html#OpenSearchIngestion.Client.tag_resource)
    ...
    def untag_resource(self, *, Arn: str, TagKeys: List[str]) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.26.121/reference/services/osis.html#OpenSearchIngestion.Client.untag_resource)
    ...
    def update_pipeline(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.26.121/reference/services/osis.html#OpenSearchIngestion.Client.update_pipeline)
    ...
    def validate_pipeline(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.26.121/reference/services/osis.html#OpenSearchIngestion.Client.validate_pipeline)
