...
class SWFClient(BaseClient):
    ...
    def delete_activity_type(self, *, domain: str, activityType: "ActivityTypeTypeDef") -> None:
        """
    ...
    def delete_workflow_type(self, *, domain: str, workflowType: "WorkflowTypeTypeDef") -> None:
        """
