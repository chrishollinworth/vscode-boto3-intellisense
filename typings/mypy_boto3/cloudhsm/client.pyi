...
class CloudHSMClient(BaseClient):
    """
    [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/cloudhsm.html#CloudHSM.Client)
    ...
    def add_tags_to_resource(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/cloudhsm.html#CloudHSM.Client.add_tags_to_resource)
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/cloudhsm.html#CloudHSM.Client.can_paginate)
    ...
    def create_hapg(self, *, Label: str) -> CreateHapgResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/cloudhsm.html#CloudHSM.Client.create_hapg)
    ...
    def create_hsm(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/cloudhsm.html#CloudHSM.Client.create_hsm)
    ...
    def create_luna_client(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/cloudhsm.html#CloudHSM.Client.create_luna_client)
    ...
    def delete_hapg(self, *, HapgArn: str) -> DeleteHapgResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/cloudhsm.html#CloudHSM.Client.delete_hapg)
    ...
    def delete_hsm(self, *, HsmArn: str) -> DeleteHsmResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/cloudhsm.html#CloudHSM.Client.delete_hsm)
    ...
    def delete_luna_client(self, *, ClientArn: str) -> DeleteLunaClientResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/cloudhsm.html#CloudHSM.Client.delete_luna_client)
    ...
    def describe_hapg(self, *, HapgArn: str) -> DescribeHapgResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/cloudhsm.html#CloudHSM.Client.describe_hapg)
    ...
    def describe_hsm(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/cloudhsm.html#CloudHSM.Client.describe_hsm)
    ...
    def describe_luna_client(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/cloudhsm.html#CloudHSM.Client.describe_luna_client)
    ...
    def generate_presigned_url(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/cloudhsm.html#CloudHSM.Client.generate_presigned_url)
    ...
    def get_config(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/cloudhsm.html#CloudHSM.Client.get_config)
    ...
    def list_available_zones(self) -> ListAvailableZonesResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/cloudhsm.html#CloudHSM.Client.list_available_zones)
    ...
    def list_hapgs(self, *, NextToken: str = None) -> ListHapgsResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/cloudhsm.html#CloudHSM.Client.list_hapgs)
    ...
    def list_hsms(self, *, NextToken: str = None) -> ListHsmsResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/cloudhsm.html#CloudHSM.Client.list_hsms)
    ...
    def list_luna_clients(self, *, NextToken: str = None) -> ListLunaClientsResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/cloudhsm.html#CloudHSM.Client.list_luna_clients)
    ...
    def list_tags_for_resource(self, *, ResourceArn: str) -> ListTagsForResourceResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/cloudhsm.html#CloudHSM.Client.list_tags_for_resource)
    ...
    def modify_hapg(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/cloudhsm.html#CloudHSM.Client.modify_hapg)
    ...
    def modify_hsm(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/cloudhsm.html#CloudHSM.Client.modify_hsm)
    ...
    def modify_luna_client(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/cloudhsm.html#CloudHSM.Client.modify_luna_client)
    ...
    def remove_tags_from_resource(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/cloudhsm.html#CloudHSM.Client.remove_tags_from_resource)
    ...
    def get_paginator(self, operation_name: Literal["list_hapgs"]) -> ListHapgsPaginator:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/cloudhsm.html#CloudHSM.Paginator.ListHapgs)
    ...
    def get_paginator(self, operation_name: Literal["list_hsms"]) -> ListHsmsPaginator:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/cloudhsm.html#CloudHSM.Paginator.ListHsms)
    ...
    def get_paginator(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/cloudhsm.html#CloudHSM.Paginator.ListLunaClients)
