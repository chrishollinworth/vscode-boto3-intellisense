...
class MigrationHubClient(BaseClient):
    """
    [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mgh.html#MigrationHub.Client)
    ...
    def associate_created_artifact(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mgh.html#MigrationHub.Client.associate_created_artifact)
    ...
    def associate_discovered_resource(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mgh.html#MigrationHub.Client.associate_discovered_resource)
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mgh.html#MigrationHub.Client.can_paginate)
    ...
    def create_progress_update_stream(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mgh.html#MigrationHub.Client.create_progress_update_stream)
    ...
    def delete_progress_update_stream(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mgh.html#MigrationHub.Client.delete_progress_update_stream)
    ...
    def describe_application_state(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mgh.html#MigrationHub.Client.describe_application_state)
    ...
    def describe_migration_task(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mgh.html#MigrationHub.Client.describe_migration_task)
    ...
    def disassociate_created_artifact(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mgh.html#MigrationHub.Client.disassociate_created_artifact)
    ...
    def disassociate_discovered_resource(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mgh.html#MigrationHub.Client.disassociate_discovered_resource)
    ...
    def generate_presigned_url(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mgh.html#MigrationHub.Client.generate_presigned_url)
    ...
    def import_migration_task(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mgh.html#MigrationHub.Client.import_migration_task)
    ...
    def list_application_states(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mgh.html#MigrationHub.Client.list_application_states)
    ...
    def list_created_artifacts(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mgh.html#MigrationHub.Client.list_created_artifacts)
    ...
    def list_discovered_resources(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mgh.html#MigrationHub.Client.list_discovered_resources)
    ...
    def list_migration_tasks(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mgh.html#MigrationHub.Client.list_migration_tasks)
    ...
    def list_progress_update_streams(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mgh.html#MigrationHub.Client.list_progress_update_streams)
    ...
    def notify_application_state(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mgh.html#MigrationHub.Client.notify_application_state)
    ...
    def notify_migration_task_state(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mgh.html#MigrationHub.Client.notify_migration_task_state)
    ...
    def put_resource_attributes(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mgh.html#MigrationHub.Client.put_resource_attributes)
    ...
    def get_paginator(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mgh.html#MigrationHub.Paginator.ListApplicationStates)
    ...
    def get_paginator(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mgh.html#MigrationHub.Paginator.ListCreatedArtifacts)
    ...
    def get_paginator(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mgh.html#MigrationHub.Paginator.ListDiscoveredResources)
    ...
    def get_paginator(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mgh.html#MigrationHub.Paginator.ListMigrationTasks)
    ...
    def get_paginator(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/mgh.html#MigrationHub.Paginator.ListProgressUpdateStreams)
