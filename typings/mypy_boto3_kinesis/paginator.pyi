...
class DescribeStreamPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [DescribeStream.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.14.47/reference/services/kinesis.html#Kinesis.Paginator.DescribeStream.paginate)
        """
...
class ListShardsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListShards.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.14.47/reference/services/kinesis.html#Kinesis.Paginator.ListShards.paginate)
        """
...
class ListStreamConsumersPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListStreamConsumers.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.14.47/reference/services/kinesis.html#Kinesis.Paginator.ListStreamConsumers.paginate)
        """
...
class ListStreamsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListStreams.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.14.47/reference/services/kinesis.html#Kinesis.Paginator.ListStreams.paginate)
        """
