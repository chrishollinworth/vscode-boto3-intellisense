...
class SchemasClient(BaseClient):
    """
    [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/schemas.html#Schemas.Client)
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/schemas.html#Schemas.Client.can_paginate)
    ...
    def create_discoverer(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/schemas.html#Schemas.Client.create_discoverer)
    ...
    def create_registry(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/schemas.html#Schemas.Client.create_registry)
    ...
    def create_schema(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/schemas.html#Schemas.Client.create_schema)
    ...
    def delete_discoverer(self, *, DiscovererId: str) -> None:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/schemas.html#Schemas.Client.delete_discoverer)
    ...
    def delete_registry(self, *, RegistryName: str) -> None:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/schemas.html#Schemas.Client.delete_registry)
    ...
    def delete_resource_policy(self, *, RegistryName: str = None) -> None:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/schemas.html#Schemas.Client.delete_resource_policy)
    ...
    def delete_schema(self, *, RegistryName: str, SchemaName: str) -> None:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/schemas.html#Schemas.Client.delete_schema)
    ...
    def delete_schema_version(
        ...
        **Request Syntax** response = client.delete_schema_version(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/schemas.html#Schemas.Client.delete_schema_version)
    ...
    def describe_code_binding(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/schemas.html#Schemas.Client.describe_code_binding)
    ...
    def describe_discoverer(self, *, DiscovererId: str) -> DescribeDiscovererResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/schemas.html#Schemas.Client.describe_discoverer)
    ...
    def describe_registry(self, *, RegistryName: str) -> DescribeRegistryResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/schemas.html#Schemas.Client.describe_registry)
    ...
    def describe_schema(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/schemas.html#Schemas.Client.describe_schema)
    ...
    def export_schema(
        ...
        **Request Syntax** response = client.export_schema( RegistryName='string',
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/schemas.html#Schemas.Client.export_schema)
    ...
    def generate_presigned_url(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/schemas.html#Schemas.Client.generate_presigned_url)
    ...
    def get_code_binding_source(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/schemas.html#Schemas.Client.get_code_binding_source)
    ...
    def get_discovered_schema(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/schemas.html#Schemas.Client.get_discovered_schema)
    ...
    def get_resource_policy(self, *, RegistryName: str = None) -> GetResourcePolicyResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/schemas.html#Schemas.Client.get_resource_policy)
    ...
    def list_discoverers(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/schemas.html#Schemas.Client.list_discoverers)
    ...
    def list_registries(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/schemas.html#Schemas.Client.list_registries)
    ...
    def list_schema_versions(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/schemas.html#Schemas.Client.list_schema_versions)
    ...
    def list_schemas(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/schemas.html#Schemas.Client.list_schemas)
    ...
    def list_tags_for_resource(self, *, ResourceArn: str) -> ListTagsForResourceResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/schemas.html#Schemas.Client.list_tags_for_resource)
    ...
    def put_code_binding(
        ...
        **Request Syntax** response = client.put_code_binding( Language='string',
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/schemas.html#Schemas.Client.put_code_binding)
    ...
    def put_resource_policy(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/schemas.html#Schemas.Client.put_resource_policy)
    ...
    def search_schemas(
        ...
        **Request Syntax** response = client.search_schemas( Keywords='string',
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/schemas.html#Schemas.Client.search_schemas)
    ...
    def start_discoverer(self, *, DiscovererId: str) -> StartDiscovererResponseTypeDef:
        ...
        **Request Syntax** response = client.start_discoverer( DiscovererId='string' ).
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/schemas.html#Schemas.Client.start_discoverer)
    ...
    def stop_discoverer(self, *, DiscovererId: str) -> StopDiscovererResponseTypeDef:
        ...
        **Request Syntax** response = client.stop_discoverer( DiscovererId='string' ).
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/schemas.html#Schemas.Client.stop_discoverer)
    ...
    def tag_resource(self, *, ResourceArn: str, Tags: Dict[str, str]) -> None:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/schemas.html#Schemas.Client.tag_resource)
    ...
    def untag_resource(self, *, ResourceArn: str, TagKeys: List[str]) -> None:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/schemas.html#Schemas.Client.untag_resource)
    ...
    def update_discoverer(
        ...
        **Request Syntax** response = client.update_discoverer( Description='string',
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/schemas.html#Schemas.Client.update_discoverer)
    ...
    def update_registry(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/schemas.html#Schemas.Client.update_registry)
    ...
    def update_schema(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/schemas.html#Schemas.Client.update_schema)
    ...
    def get_paginator(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/schemas.html#Schemas.Paginator.ListDiscoverers)
    ...
    def get_paginator(self, operation_name: Literal["list_registries"]) -> ListRegistriesPaginator:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/schemas.html#Schemas.Paginator.ListRegistries)
    ...
    def get_paginator(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/schemas.html#Schemas.Paginator.ListSchemaVersions)
    ...
    def get_paginator(self, operation_name: Literal["list_schemas"]) -> ListSchemasPaginator:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/schemas.html#Schemas.Paginator.ListSchemas)
    ...
    def get_paginator(self, operation_name: Literal["search_schemas"]) -> SearchSchemasPaginator:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.13/reference/services/schemas.html#Schemas.Paginator.SearchSchemas)
